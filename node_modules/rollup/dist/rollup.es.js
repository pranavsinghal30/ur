...
class FunctionScope extends ReturnValueScope {
    constructor(parent, context) {
        ...
        this.variables.set('arguments', (this.argumentsVariable = new ArgumentsVariable(super.getParameterVariables(), context)));
    ...
    getOptionsWhenCalledWith({ args, withNew }, options) {
        return options
            .replaceVariableInit(this.thisVariable, withNew ? new UnknownObjectExpression() : UNKNOWN_EXPRESSION)
